...
app.post("/authorization-callback", loginStatusChecker, function _callee2(req, res) {
...
app.get("/cft-icon-64px", function _callee3(req, res) {
...
app.post("/isloggedIn", loginStatusChecker, function _callee4(req, res) {
...
app.post("/is-account-authorized", [loginStatusChecker, isUserAuthorized], function _callee5(req, res) {
...
app.get("/check-cookie", function (req, res) {
  var tokenCheck = req.cookies.cftAuth;
  console.log(tokenCheck);
});
app.post("/authorize", loginStatusChecker, function _callee6(req, res) {
...
app.post("/start", [loginStatusChecker, isUserAuthorized, userToken], function _callee7(req, res) {
...
app.post("/add", [loginStatusChecker, isUserAuthorized, userToken, signatureChecker], function _callee8(req, res) {
...
app.post("/find-member-id", [loginStatusChecker, isUserAuthorized, userToken, signatureChecker], function _callee9(req, res) {
...
app.post("/delete-from-boards", [loginStatusChecker, isUserAuthorized, userToken, signatureChecker], function _callee10(req, res) {
...
app.post("/get-workspace-name", [loginStatusChecker, isUserAuthorized, userToken, signatureChecker], function _callee11(req, res) {
