...
function getMemberId(paramToGetUsernameIds) {
  var boardId, desiredUsername, key, token, boardsDetailsUrl, response, boardMembersDetails, desiredMember, memberId;
  return regeneratorRuntime.async(function getMemberId$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          boardId = paramToGetUsernameIds.boardId;
          desiredUsername = paramToGetUsernameIds.desiredUsername;
        ...
        case 8:
          ...
          desiredMember = boardMembersDetails.find(function (member) {
            return member.username === desiredUsername;
          });
