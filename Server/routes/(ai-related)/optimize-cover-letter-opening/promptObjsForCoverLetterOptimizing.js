...
Ensure it follow this format example : ${youFocusApproachFormat} but with the pain point above being addressed instead of the pain point in the format example: 
