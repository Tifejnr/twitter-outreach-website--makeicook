...
export default function SelectMeans(props) {
  ...
  function storeMeansInStorage(meansChosen) {
    if (actionToBePerformed == additionAction)
      return localStorage.setItem("meansChosenAddToBoards", meansChosen);
    if (actionToBePerformed == deletionAction)
      return localStorage.setItem("meansChosenDeleteFromBoards", meansChosen);
  }
      ...
      <form>
        <div className="selector">
          ...
          <div
            ...
            title="Click to select preferred means"
          >
          ...
          <ul style={openMeansAvailableStyle}>
            {actionToBePerformed == additionAction && (
              <li className="options" onClick={handleEmailMeansSelection}>
                <p>Email</p>
              </li>
            )}
            <li className="options" onClick={handleNameMeansSelection}>
              <p>{nameMeans}</p>
            </li>
          </ul>
        </div>
