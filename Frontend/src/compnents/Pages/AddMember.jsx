...
const memeberCheckboxMustBeCheckedMess =
  "Please check at least a member to be added";
...
export default function AddMember() {
  ...
  useEffect(() => {
    ...
    const meansChosenAddToBoards = localStorage.getItem(
      "meansChosenAddToBoards"
    );
    if (meansChosenAddToBoards)
      return (
        setMeansOfExceution(meansChosenAddToBoards),
        setSelectLabel(meansChosenAddToBoards)
      );
    return (
  ...
  return (
    <>
      {openProgressBar ? (
        <ProgressExceution executionParams={executionParams} />
      ) : (
        <>
          <HomeNavBar
            innerText={
            ...
            {!meansOfExceution ? (
              ...
              >
                {meansOfExceution == emailMeans ? (
                  ...
                  >
                    ...
                    <h1 id="memberToDeleteHeading">
                      Select Members to be Added Below
                    </h1>
                ...
                >
                  ...
                  <SearchBoards
                    searchPlaceholderTitle={searchPlaceholderTitle}
                  />
