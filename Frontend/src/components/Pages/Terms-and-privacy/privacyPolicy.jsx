      ...
      <section className="tools-section-cont main-pricing-section-alone about-us-main">
        ...
        >
          <article>
            <section>
              <p>
                ‘makeicook.com&apos;, ‘Make I Cook&apos;, ‘we&apos;, ‘us&apos;,
                ‘Platform&apos;, ‘Company&apos;, or ‘our&apos;. values your
                privacy and hence provides you with the following information.
              </p>
              ...
              <p>
                ...
                personal data you offer us. Make I Cook enables compliance with
                the GDPR when it processes personal data on behalf of its
                customers. If you live in California and want to learn more
                about your rights under the California Consumer Privacy Act of
                2018 (“CCPA“).
              </p>
              ...
              <div>
                ...
                <ul>
                  ...
                  <li>
                    an authorized user Make I Cook agreeing to our Terms of
                    Service (“End User”)
                  </li>
                  <li>
            ...
            <section>
              ...
              <p>
                Make I Cook is dedicated to offering its cutting-edge service
                while respecting everyone&lsquo;s privacy and abiding by all
              ...
              <p>
                ...
                data in the Make I Cook&apos;s Database, and we do not maintain
                personal or private contact information in our database.
              </p>

              <p>
                Make I Cook only collects data that is required and does not
                gather sensitive information like health, religious views,
            ...
            <section>
              ...
              <p>
                We collect and systematically analyze data concerning Make I
                Cook, customers, and visitors as part of our information
            ...
            <section>
              ...
              <p>
                Make I Cook End Users are required to submit their email address
                and payment details for paid plans (including a credit card
                number). We do not collect or process your payment information
                directly for this.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                purpose for which it was collected, as well as the
                situation&apos;s requirements and the necessity to remove
                obsolete, unneeded information as soon as possible.
              </p>

              <p>
                Make I Cook Contacts: We keep your Data for as long as we need
                it to perform our Services and then archive it to meet our legal
                responsibilities, settle disputes, and enforce our rules.
              </p>

              <p>
                We save your data for as long as you have an active Make I Cook
                account. In order to comply with our legal and contractual
                obligations or to protect ourselves from any potential disputes
                (as required by laws applicable to record-keeping and to have
                proof and evidence concerning our relationship, should any legal
                issues arise following the termination of your account), we may
                keep your data in an intermediate archive following the deletion
                of your account.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Make I Cook reserves the right to alter this Privacy Policy at
                any time to reflect changes in the way we treat data. If we make
                material changes to this policy (such as a change in our
                processing purposes, a change in the identity of the controller,
                or even a change in the way you can exercise your rights in
                relation to our processing activities), we will notify you via
                email or a notice on our website&apos;s homepage, as
